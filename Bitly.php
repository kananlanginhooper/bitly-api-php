...
/**
 * Build a query string from an array of param => values.
 * Handle
...
class Bitly {
	 ...
	 * @param string $hash
	 *        	(Optional) The hash component of a bitly short URL, e.g. "1234"
	 * @param $expandUser (Optional)
	 *        	Include extra information about the user.
	 *        	
	 * @return array
	 *
	 ...
	 *
	 * @param string $link
	 *        	A bitly link, e.g. 'http://bit.ly/1234'.
	 * @param array $params
	 *        	An array of optional values from above.
	 *        	
	 ...
	 *
	 * @param string $url
	 *        	A long URL to shorten and save.
	 * @param array $params
	 ...
	 *        	
	 * @return array A list of Bitly links.
	 *        
	 ...
	 *        	
	 * @return array An array of results, each result is an associative array and its
	 *         contents will depend on 'fields'.
	 *        
	 * @see http://dev.bitly.com/data_apis.html#v3_search
	 */
	public function search($query, $limit = 10, $offset = 0, $lang = null, $cities = null, $domain = null, Array $fields = null){
		$params = array(
				'query' => $query,
				'limit' => $limit,
				'offset' => $offset 
	...
	/**
	 * Returns the from the linked page, as determined by the
	 ...
	 */
	public function linkClicks($link, $unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'link' => $link,
				'unit' => $unit,
				'timezone' => $timezone,
	 ...
	 */
	public function linkCountries($link, $unit = 'day', $units = null, $timezone = 'America/New_York', $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'link' => $link,
				'unit' => $unit,
				'timezone' => $timezone,
	 ...
	 */
	public function linkEncoders($link, $myNetwork = null, $limit = 10, $expandUser = null){
		$params = array(
				'link' => $link,
				'limit' => $limit 
		);
	 ...
	 */
	public function linkReferrers($link, $unit = 'day', $units = null, $timezone = 'America/New_York', $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'link' => $link,
				'unit' => $unit,
				'limit' => $limit,
	 ...
	 */
	public function linkReferrersByDomain($link, $unit = 'day', $units = null, $timezone = 'America/New_York', $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'link' => $link,
				'unit' => $unit,
				'limit' => $limit,
	 ...
	 */
	public function linkReferringDomains($link, $unit = 'day', $units = null, $timezone = 'America/New_York', $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'link' => $link,
				'unit' => $unit,
				'limit' => $limit,
	 ...
	 */
	public function linkShares($link, $unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'link' => $link,
				'unit' => $unit,
				'limit' => $limit,
	 ...
	 *        	(Optional)
	 * @param int $modifiedAfter
	 *        	(Optional)
	 * @param bool $expandClientId
	 *        	(Optional)
	 * @param string $archived
	 *        	(Optional) "on", "off" or "both".
	 ...
	 */
	public function userLinkHistory($link = null, $limit = 50, $offset = null, $createdBefore = null, $createdAfter = null, $modifiedAfter = null, $expandClientId = null, $archived = null, $private = null, $user = null){
		$params = array();
		if($link !== null) {
			$params['link'] = $link;
		}
	 ...
	 */
	public function userNetworkHistory($offset = null, $expandClientId = false, $limit = 20, $expandUser = null){
		$params = array(
	 ...
	 */
	public function userClicks($unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'unit' => $unit,
				'timezone' => $timezone,
				'limit' => $limit,
	 ...
	 */
	public function userCountries($unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'unit' => $unit,
				'timezone' => $timezone,
				'limit' => $limit,
	 ...
	 */
	public function userPopularLinks($unit = 'day', $units = null, $timezone = 'America/New_York', $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'unit' => $unit,
				'timezone' => $timezone,
				'limit' => $limit,
	 ...
	 */
	public function userReferrers($unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'unit' => $unit,
				'timezone' => $timezone,
				'limit' => $limit,
	 ...
	 */
	public function userReferringDomains($unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'unit' => $unit,
				'timezone' => $timezone,
				'limit' => $limit,
	 ...
	 */
	public function userShareCounts($unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'unit' => $unit,
				'timezone' => $timezone,
				'limit' => $limit,
	 ...
	 */
	public function userShareCountsByShareType($unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'unit' => $unit,
				'timezone' => $timezone,
				'limit' => $limit,
	 ...
	 */
	public function userShortenCounts($unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'unit' => $unit,
				'timezone' => $timezone,
				'limit' => $limit,
	 ...
	 *        	The URL of the bundle to archive.
	 *        	
	 * @return bool
	 *
	 ...
	 *        	Bitly login or email address to add.
	 *        	
	 * @return array
	 *
	 ...
	 *        	URL of the bundle.
	 * @param string $collaborator
	 *        	Bitly login of the collaborator to remove.
	 *        	
	 * @return array
	 *
	 ...
	 */
	public function bundleEdit($bundleLink, $title = null, $description = null, $private = null, $preview = null, $ogImage = null){
		$params = array(
				'bundle_link' => $bundleLink 
		);
		$keys = array();
	 ...
	 *        	URL of the bundle.
	 * @param string $link
	 *        	Bitly link in the bundle.
	 * @param string $comment
	 *        	The comment, must be <= 512 characters.
	 *        	
	 * @return array
	 *
	 ...
	 * @param string $comment
	 *        	The edited comment, must be <= 512 characters.
	 *        	
	 * @return array
	 *
	 ...
	 *        	Bitly link in the bundle.
	 * @param string $title
	 *        	(Optional) The new title.
	 * @param bool $preview
	 *        	(Optional) Display preview content.
	 *        	
	 * @return array
	 *
	 * @see http://dev.bitly.com/bundles.html#v3_bundle_link_edit
	 */
	public function bundleLinkEdit($bundleLink, $link, $title = null, $preview = null){
		$params = array(
				'bundle_link' => $bundleLink,
				'link' => $link 
		);
	...
	public function bundlePendingCollaboratorRemove($bundleLink, $collaborator){
		...
		$result = $this->call('v3/bundle/pending_collaborator_remove', $params);
		return $result['bundle'];
	}
	 ...
	 */
	public function userTrackingDomainClicks($domain, $unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'domain' => $domain,
				'unit' => $unit,
				'timezone' => $timezone,
	 ...
	 */
	public function userTrackingDomainShortenCounts($domain, $unit = 'day', $units = null, $timezone = 'America/New_York', $rollup = null, $limit = 100, $unitReferenceTs = 'now'){
		$params = array(
				'domain' => $domain,
				'unit' => $unit,
				'timezone' => $timezone,
		...
		$result = $this->call('v3/user/tracking_domain_shorten_counts', $params);
	 ...
	 * @param bool $post
	 *        	Do an HTTP POST instead of GET.
	 * @param bool $json
	...
	protected function call($endpoint, Array $params = null, $post = false, $json = true){
		...
		$params['format'] = 'json';
		if($this->accessToken !== null && !array_key_exists('access_token', $params)) {
		...
		if($json) {
			...
			if($result['status_code'] !== 200) {
				throw new BitlyAPIError($result['status_txt'], (int)$result['status_code']);
			}
			return $result['data'];
		}
		return $result;
